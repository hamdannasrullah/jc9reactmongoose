...
class Home extends Component {
    ...
    addTask = (userid) => {
        ...
        axios.post (
            '/tasks/' + userid,
            {
                description // persingkat description: description
            }
        ).then ( () => {
            // get tasks
            ...
            if(this.props.userid){
                return (
                    <div className="container">
                            ...
                            <button type="submit" className="btn btn-block btn-primary mt-3" onClick={() => this.addTask(this.props.userid)}>Masukkan Tugas!</button>
